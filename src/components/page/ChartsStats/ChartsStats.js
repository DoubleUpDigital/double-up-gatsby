        ...
        <div className={`chartsStats__container container container--wide`}>
          <section>
            <div className="chartsStats__intro">
              {data.sectionLabel && <span className={`component__tag chartsStats__tag tag animate-on-scroll`}>{data.sectionLabel}</span>}
              {data.heading && <h2 className="component__heading chartsStats__heading animate-on-scroll animate-on-scroll--fade-up">{data.heading}</h2>}
              {data.content && <div className="component__content chartsStats__text animate-on-scroll">{data.content}</div>}
            </div>
            {data.charts !== null && (
          ...
          <section>
            {data.stats.dataPoints !== null && (
              <div className="chartsStats__stats">
                {data.stats.heading && <h3 className="chartsStats__stats-heading animate-on-scroll animate-on-scroll--fade-up">{data.stats.heading}</h3>}
